...
fbq('init', '1923384841955068');
fbq('track', 'PageView');`}
        </Script>
        <noscript>
          {/* Meta requires a plain tracking pixel when JavaScript is disabled. */}
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            height="1"
            width="1"
            style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=1923384841955068&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        <Navigation />
