      ...
      <main className="relative overflow-hidden px-4 py-6 sm:px-6 sm:py-10 lg:px-8">
        ...
        <div className="relative mx-auto max-w-4xl">
          <header className="mx-auto mb-6 max-w-3xl text-center sm:mb-8">
            ...
            <h1 className="mt-3 text-3xl font-bold leading-tight text-brand-darkBlue sm:text-4xl lg:text-5xl">Communication Milestone Check-In</h1>
...
function BackButton({ onBack }: { onBack: () => void }) {
  return <div className="mt-7"><button type="button" onClick={onBack} className="font-semibold text-gray-600 underline underline-offset-4 hover:text-brand-darkBlue focus:outline-none focus-visible:ring-4 focus-visible:ring-brand-bluePurple/25">Back</button></div>;
}
