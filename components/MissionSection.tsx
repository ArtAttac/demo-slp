...
export default function MissionSection() {
  return (
    <section className="relative min-h-screen flex items-center py-20 sm:py-28 overflow-hidden bg-gradient-to-br from-brand-darkBlue via-brand-bluePurple to-brand-pink">
