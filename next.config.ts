...
const nextConfig: NextConfig = {
  images: {
    remotePatterns: [
      ...
      // Vercel Blob — stores blog featured images
    ...
    return [
      {
        ...
        headers: [
          ...
          // Content Security Policy
          {
            ...
            value: [
              "default-src 'self'",
              "script-src 'self' 'unsafe-eval' 'unsafe-inline' https://vercel.live https://www.eventbrite.com https://va.vercel-scripts.com",
